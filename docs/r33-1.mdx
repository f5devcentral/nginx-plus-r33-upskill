...
You can refer to the path shown as Option 1 in the diagram above. This one is the most simplest of the three because
you do not have any restrictions for the NGINX Plus instance and it can connect to the Reporting Endpoint directly.
You are not required to take any manual actions for submitting the usage report.

#### Option 2a: NGINX Plus managed by NIM connected to internet

There may be a case where the NGINX Plus instance cannot be directly be connected to the internet. Or you may not be
comfortable with the fact your NGINX instance is sending traffic out to the internet. If this fits your case, you have
the option of having your NGINX Plus instance managed by NIM where NIM is connected to the internet. NIM then reports
your NGINX Plus usage to the F5 License Server automatically. Like Option 1 above, you are not required to take any
manual actions for submitting the usage report.
