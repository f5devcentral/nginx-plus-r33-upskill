...
1. Demostrate licensing changes starting with NGINX Plus R33
...
When implementing option 1 or 2a you will have to allow egress traffic from either the NGINX Plus instance or the NIM
install to **product.connect.nginx.com **
